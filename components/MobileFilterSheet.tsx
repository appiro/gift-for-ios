...
export default function MobileFilterSheet({ open, onClose }: Props) {
      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 z-50 bg-background-card rounded-t-3xl shadow-2xl max-h-[80vh] flex flex-col"
          >
            {/* Handle */}
            ...
            <div className="flex items-center justify-between px-5 py-3 border-b border-border-light">
              <h2 className="font-bold text-text-main text-base">絞り込み</h2>
            ...
            <div className="overflow-y-auto flex-1 px-5 py-4 space-y-6 pb-8">
              ...
              {/* Budget */}
              <div>
                <h3 className="text-xs font-bold text-text-sub uppercase tracking-wide mb-3">予算</h3>
            ...
            {/* Apply button */}
            <div className="px-5 pb-8 pt-3 border-t border-border-light">
              <button
                onClick={onClose}
                className="w-full py-3.5 bg-primary text-white rounded-full font-bold text-sm shadow-sm active:scale-[0.98] transition-transform"
              >
                この条件で絞り込む
